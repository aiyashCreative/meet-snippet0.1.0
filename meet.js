...
const getQuery = () => {
    ...
    if (meeting_id && meeting_token && username) {
        ...
        meetingVariables.userRole = "admin"
...
const meetingObj = {
    ...
    initializeMeeting: () => {
        ...
        meetingObj.meeting.on("participant-joined", (participant) => {
            ...
            //     $("#admin-mouse-position").append(videoElement);
            //     $("#admin-mouse-position").append(audioElement);
            // } else {
            //     $("#current-mouse-position").append(videoElement);
            //     $("#current-mouse-position").append(audioElement);
            // }
        }); 
...
const mouse = {
    ...
    handleMouse: (event) => {
        ...
        $("#current-mouse-position").css("left", x);
        $("#current-mouse-position").css("top", y);
    }
